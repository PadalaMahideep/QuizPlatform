...
<div class="col-md-10">
<a href="mailto:mettapardha.saradhi2019@vitstudent.ac.in" style="color:#000000">saisri.harsha2019@vitstudent.ac.in</a><br /><br />
...
<a href="https://vit.ac.in/" target="_blank">About us</a>
</div>
<div class="col-md-3 box">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
				 <div class="col-md-4">
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">B A Sai Sri Harsha</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+918688996388</h4>
		<h4 style="font-family:'typo' ">saisri.harsha2019@vitstudent.ac.in</h4>
		<h4 style="font-family:'typo' ">Vellore Institute Of Technology ,Vellore</h4>
    <br>
    <br>
    <a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Pardha Saradhi Metta</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+919789775959</h4>
		<h4 style="font-family:'typo' ">mettapardha.saradhi2019@vitstudent.ac.in</h4>
